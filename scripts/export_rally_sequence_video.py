...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--reaction-time", type=float, default=0.0)
    parser.add_argument("--court-mode", choices=("1d", "2d"), default="2d")
    parser.add_argument("--player-speed", type=float, default=3.2)
    ...
    parser.add_argument("--intercept-count", type=int, default=25)
    parser.add_argument("--vx-bins", type=int, default=11)
    parser.add_argument("--vy-bins", type=int, default=15)
    parser.add_argument("--vz-bins", type=int, default=11)
    parser.add_argument("--x-rec-bins", type=int, default=5)
    parser.add_argument("--y-rec-bins", type=int, default=5)
    return parser.parse_args()


def _resolve_initial_server(value: str, train_side: Side) -> Side:
...
def main() -> None:
    ...
    current_server = _resolve_initial_server(args.initial_server, args.train_side)
    score_left = 0
    score_right = 0
